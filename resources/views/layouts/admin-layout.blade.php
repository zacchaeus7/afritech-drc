...
<head>
    ...
    <link rel="stylesheet" href="{{url('admin/dist/css/adminlte.min2167.css?v=3.2.0')}}">
...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        <a href="index3.html" class="brand-link">
            <img src="" alt="Afritech Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2014-2021 <a href="https://adminlte.io/">Afritech-Admin</a>.</strong>
        All rights reserved.
...
<script src="{{url('admin/dist/js/adminlte2167.js?v=3.2.0')}}"></script>
<script src="dist/js/demo.js"></script>
<script src="dist/js/pages/dashboard.js"></script>
</body>
<!-- Mirrored from adminlte.io/themes/v3/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 21 Mar 2022 10:56:13 GMT -->
</html>